...
Mesclando todos os dados de Unidades, Setores, Pastas e Processos, uma vez que cada unidade possui setores e nos setores são criadas pastas, compostas por processos judiciais, o resultado apresenta uma gama de possibilidades de análise. 

A princípio, é possível constatar as unidades com as maiores quantidades de processos (dados de 2017 e 2018 até o mês de outubro) e a quantidade média de processos por Região.
...
Para a criação dessa tabela foram consideradas as 30 unidades com mais processos no período de 2017 a 2018 (mês de outubro). Novamente, as regiões com mais processos não necessariamente são as maiores, mas certamente são as que possuem advogados mais eficientes.
...
É possível deduzir que o ano eleitoral influencie no andamento dos julgamentos dos processos judiciais em trâmite.
